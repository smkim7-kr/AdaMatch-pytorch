...
def make_optimizer(args, model):
    ...
    if args.optimizer == 'SGD':
        ...
        return Ralamb(params, lr=args.lr, weight_decay=args.weight_decay)
    elif args.optimizer == 'LOOKAHEAD':
        return Over9000(params, lr=args.lr, weight_decay=args.weight_decay)
    else:
        raise Exception('unknown lr scheduler: {}'.format(args.optimizer))
